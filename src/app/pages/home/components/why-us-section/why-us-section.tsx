        ...
        <div className=" grid grid-cols-2 lg:px-28 px-4 gap-1 py-14">
          <div className="col-span-2 lg:col-span-1 space-y-16 lg:w-[640px]">
            ...
            <section className="space-y-6">
              <h2 className="flex items-center gap-2 font-bold text-main relative before:content-['Why_Us'] before:absolute before:-bottom-4 before:hidden lg:before:block before:-z-10 before:text-charcoal/10 z-10 dark:before:text-white/20 before:text-[64px] before:font-bold before:text-main before:whitespace-nowrap">
              ...
              <h2 className="font-bold text-[40px] uppercase font-baloo text-charcoal dark:text-grayExtra">
                Elevate fitness with the <span className="text-main"> best way </span>possible
              </h2>
