...
const RecommendedMeals = ({ meal, image }: { meal: string; image: string }) => {
  return (
    ...
    >
      <div className="absolute top-[70%] bottom-0 left-0 right-0 bg-charcoal/50 flex flex-col justify-around p-3 space-y-2">
        <h2 className="font-baloo font-bold text-xl tracking-[2px] text-grayExtra uppercase">
          {meal}
        </h2>
        <div className="flex items-center gap-2 cursor-pointer">
          <p className="text-main font-baloo font-medium text-lg">Read More</p>
